...
class AbilitySelectionMenu extends Container {
  ...
  renderBackground() {
    this.bg = new Graphics().rect(0, 0, MENU_WIDTH, MENU_HEIGHT).fill(HUD_FILL_COLOR).stroke({
  ...
  renderBottomButtons() {
    ...
    const clearBg = new Graphics().rect(0, 0, BUTTON_WIDTH, BUTTON_HEIGHT).fill(0x000000).stroke({ color: 0x666666, width: 2 })
    ...
    const applyBg = new Graphics().rect(0, 0, BUTTON_WIDTH, BUTTON_HEIGHT).fill(0x000000).stroke({ color: 0x00aa00, width: 2 })
