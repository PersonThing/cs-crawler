...
func _load_enemies() -> void:
	...
	if data:
		...
		print("[CONFIG] Enemy types available: ", enemies.keys())
	else:
...
func get_enemy(enemy_type: String) -> Dictionary:
	print("[CONFIG] get_enemy called with type: '", enemy_type, "'")
	var result = enemies.get(enemy_type, {})
	print("[CONFIG] Found enemy data: ", not result.is_empty())
	return result
